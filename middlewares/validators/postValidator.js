...
exports.createPostRules = [
    ...
    // ⭐ ВАЛІДАЦІЯ TAGS (те що вимагалось у додатковому завданні)
    body('tags')
        .optional()
        .isArray({ max: 10 }).withMessage('max 10 tags allowed'),
...
exports.searchPostsRules = [
    query('q')
        ...
        .isLength({ min: 2 }).withMessage('search query min length is 2')
];
